...
bsc_basic    = pd.read_csv('./results/bsc_basic_metrics.csv')
bsc_labels   = pd.read_csv('./results/bsc_advanced_metrics_labels.csv')
...
def plot_grouped_boxplot(data_polygon, data_ethereum, data_bsc, ax, 
